     ...
     />
      ...
      >
        <div
          ...
          w-[100%] justify-center px-[20px] ${ selectOption === "Fantasty" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"} `} 
          onClick ={()=>{setSelectOption("Fantasty")}}
          >
          Fantasty
        </div>
        <div
          className= {`flex items-center
          w-[100%] justify-center px-[20px] ${ selectOption === "Info" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"}`} 
          onClick ={()=>{setSelectOption("Info")}}
        >
          Info
        </div>
        <div
          className={`flex items-center
          w-[100%] justify-center px-[20px] ${ selectOption == "Live" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"}`}
          onClick ={()=>{setSelectOption("Live")}}
       >
          Live
        </div>
        <div
          className={`flex items-center
            w-[100%] justify-center px-[20px] ${ selectOption == "Scoredcard" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"}`}
            onClick ={()=>{setSelectOption("Scoredcard")}}
        >
          Scoredcard
        </div>
        <div
          className={`flex items-center
            w-[100%] justify-center px-[20px] ${ selectOption === "Squard" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"}`}
            onClick ={()=>{setSelectOption("Squard")}}
        >
          Squard
        </div>
        <div
          className={`flex items-center
            w-[100%] justify-center px-[20px] ${ selectOption === "Highlights" ? "border-b-[#F89437] border-b-[2px]" : "border-b-white"}`}
            onClick ={()=>{setSelectOption("Highlights")}}
        >
          Highlights
        </div>
      </div>
