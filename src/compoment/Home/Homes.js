...
const Homes = () => {
  ...
  useEffect(() => {
    ...
    const getdataHander = async () => {
      ...
      setUsers({ ...response.data.results[1], logo: titleresponse.data.images.logos[0].file_path, genres: titleresponse.data.genres })
  ...
  return (
    <div className=' relative  '>
      ...
      <div className=' absolute top-[138px] left-[149px] z-[9]'>
        ...
        <div className='flex gap-x-[21px] mt-[21px]'>
          ...
          <button  className='text-[20px]   py-[13px] px-[22px] text-[#FFFFFF] box-border
            bg-[#5C5C5C] rounded-[30px] flex  items-center gap-x-[18px]'>MY LIST<span className='text-[36px] text-[#FFFFFF]'> +</span></button>
        </div>
