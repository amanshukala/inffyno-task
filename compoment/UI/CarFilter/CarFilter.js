...
const CarFilter = ({ carData, setAllCars, setAllCount }) => {
  ...
  const interiorFet =
    allData &&
    Object.entries(allData.features)[0] &&
    Object.entries(allData.features)[0][1];
  const techFet =
    allData &&
    Object.entries(allData.features)[1] &&
    Object.entries(allData.features)[1][1];
  const safFet =
    allData &&
    Object.entries(allData.features)[2] &&
    Object.entries(allData.features)[2][1];
  const extFet =
    allData &&
    Object.entries(allData.features)[3] &&
    Object.entries(allData.features)[3][1];
  const others =
    allData &&
    Object.entries(allData.features)[4] &&
    Object.entries(allData.features)[4][1];
  ...
  return (
    <div className="text-[black] bg-[#FFFFFF] rounded-[10px]  border-[1px] border-solid border-[#F2F2F5] w-[312px]  text-center pt-[23px] ">
      <div className="bg-[#FFFFFF] relative">
        ...
        <div className="flex justify-between mx-[16px] mt-[15px]">
          <p className="font-[500] text-[12px] leading-[16px] text-[#28293D]">
            $0
          </p>
          <p className="font-[500] text-[12px] leading-[16px] text-[#28293D]">
            $100,000
        ...
        <div className="mt-[15px]">
          <section className=" flex flex-col py-[10px] gap-y-[25px] ">
            <section className=" ">
              <DetailDropDown
                index={1}
                dropDownTitle="Style"
                title1="BODY STYLE"
                target_key={["bodystyleData", "extcolorData", "intcolorData"]}
                data1={allData.bodyTypes}
                title2="EXTERIOR COLOR"
                data2={allData.extColors}
                title3="INTERIOR COLOR"
                data3={allData.intColors}
              />
            </section>
            <section className=" ">
              <DetailDropDown
                index={2}
                dropDownTitle="Performance"
                title1="TRANSMISSION"
                target_key={[
                  "transmissionsData",
                  "dtrainsData",
                ...
                data1={allData.transmissions}
                title2="DRIVE TRAIN"
                data2={allData.dtrains}
                title3="FUEL TYPE"
                data3={allData.fuelType}
              />
            </section>
            <section className=" ">
              <DetailDropDown
                index={3}
                dropDownTitle="Features"
                title1={"INTERIOR FEATURES"}
                target_key={[
                  "InteriorFeature",
                  "TenchnologyFeature",
                  "SafetyFeature",
                ...
                data1={interiorFet}
                title2={"TECHNOLOGY FEATURES"}
                data2={techFet}
                title3={"SAFETY FEATURES"}
                data3={safFet}
                title4={"EXTERIOR FEATURES"}
                data4={extFet}
                title5={"OTHERS"}
                data5={others}
              />
